...
check_in_frame=Frame(root,bg=mycolor,padx=10,pady=10)
user_option_img_frame=Frame(root)
user_option_frame=Frame(root)
room_status_frame=Frame(root)
current_booking_frame=Frame(root)
current_booking_frame.grid(row=0,column=0)
select_room_frame=Frame(root)
select_room_label_frame=Frame(root,padx=10,pady=10)
check_out_frame=Frame(root)
show_booking_frame=Frame(root)
details_frame=Frame(root)
inventory_frame=Frame(root)
details_frame.grid(row=0,column=0)
current_stock_frame=Frame(root,background=mycolor)
update_stock_frame=Frame(root,background=mycolor)
laundry_box_frame=Frame(root)
laundry_recieved_frame=Frame(root,background=mycolor)
send_laundry_frame=Frame(root,background=mycolor)
show_send_laundry_frame=Frame(root,background=mycolor)
search_laundry_bet_date_frame=Frame(root,background=mycolor)
show_rec_laundry_frame=Frame(root,background=mycolor)
...
def check_in_continue():
    check_in_frame.grid_forget()
    select_room_label=Label(select_room_frame,text='Select the room',font=('Helvetica',15))
    ...
    room_001=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 001',compound=TOP,command=lambda:transfer_check_in_data('1'))
    room_001.image=vac_room_img

    room_002=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 002',compound=TOP,command=lambda:transfer_check_in_data('2'))
    room_002.image=vac_room_img

    room_101=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 101',compound=TOP,command=lambda:transfer_check_in_data('101'))
    room_101.image=vac_room_img

    room_102=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 102',compound=TOP,command=lambda:transfer_check_in_data('102'))
    room_102.image=vac_room_img

    room_103=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 103',compound=TOP,command=lambda:transfer_check_in_data('103'))
    room_103.image=vac_room_img

    room_104=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 104',compound=TOP,command=lambda:transfer_check_in_data('104'))
    room_104.image=vac_room_img

    room_105=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 105',compound=TOP,command=lambda:transfer_check_in_data('105'))
    room_105.image=vac_room_img

    room_106=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 106',compound=TOP,command=lambda:transfer_check_in_data('106'))
    room_106.image=vac_room_img

    room_201=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 201',compound=TOP,command=lambda:transfer_check_in_data('201'))
    room_201.image=vac_room_img

    room_202=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 202',compound=TOP,command=lambda:transfer_check_in_data('202'))
    room_202.image=vac_room_img

    room_203=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 203',compound=TOP,command=lambda:transfer_check_in_data('203'))
    room_203.image=vac_room_img

    room_204=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 204',compound=TOP,command=lambda:transfer_check_in_data('204'))
    room_204.image=vac_room_img

    room_205=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 205',compound=TOP,command=lambda:transfer_check_in_data('205'))
    room_205.image=vac_room_img

    room_206=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 206',compound=TOP,command=lambda:transfer_check_in_data('206'))
    room_206.image=vac_room_img

    room_301=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 301',compound=TOP,command=lambda:transfer_check_in_data('301'))
    room_301.image=vac_room_img

    room_302=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 302',compound=TOP,command=lambda:transfer_check_in_data('302'))
    room_302.image=vac_room_img

    room_303=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 303',compound=TOP,command=lambda:transfer_check_in_data('303'))
    room_303.image=vac_room_img

    room_304=Button(select_room_frame,image=vac_room_img,padx=10,pady=10,text='room 304',compound=TOP,command=lambda:transfer_check_in_data('304'))
    ...
    for number in res:
        ...
        if number[15]=='1':
            room_001=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 001',compound=TOP,command=lambda:transfer_check_in_data('1'))
            room_001.image=occ_room_img
        if number[15]=='2':
            room_002=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 002',compound=TOP,command=lambda:transfer_check_in_data('2'))
            room_002.image=occ_room_img
        if number[15]=='101':
            room_101=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 101',compound=TOP,command=lambda:transfer_check_in_data('101'))
            room_101.image=occ_room_img
        if number[15]=='102':
            room_102=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 102',compound=TOP,command=lambda:transfer_check_in_data('102'))
            room_102.image=occ_room_img
        if number[15]=='103':
            room_103=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 103',compound=TOP,command=lambda:transfer_check_in_data('103'))
            room_103.image=occ_room_img
        if number[15]=='104':
            room_104=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 104',compound=TOP,command=lambda:transfer_check_in_data('104'))
            room_104.image=occ_room_img
        if number[15]=='105':
            room_105=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 105',compound=TOP,command=lambda:transfer_check_in_data('105'))
            room_105.image=occ_room_img
        if number[15]=='106':
            room_106=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 106',compound=TOP,command=lambda:transfer_check_in_data('106'))
            room_106.image=occ_room_img
        if number[15]=='201':
            room_201=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 201',compound=TOP,command=lambda:transfer_check_in_data('201'))
            room_201.image=occ_room_img
        if number[15]=='202':
            room_202=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 202',compound=TOP,command=lambda:transfer_check_in_data('202'))
            room_202.image=occ_room_img
        if number[15]=='203':
            room_203=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 203',compound=TOP,command=lambda:transfer_check_in_data('203'))
            room_104.image=occ_room_img
        if number[15]=='204':
            room_204=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 204',compound=TOP,command=lambda:transfer_check_in_data('204'))
            room_204.image=occ_room_img
        if number[15]=='205':
            room_205=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 205',compound=TOP,command=lambda:transfer_check_in_data('205'))
            room_205.image=occ_room_img
        if number[15]=='206':
            room_206=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 206',compound=TOP,command=lambda:transfer_check_in_data('206'))
            room_206.image=occ_room_img
        if number[15]=='301':
            room_301=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 301',compound=TOP,command=lambda:transfer_check_in_data('301'))
            room_301.image=occ_room_img
        if number[15]=='302':
            room_302=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 302',compound=TOP,command=lambda:transfer_check_in_data('302'))
            room_302.image=occ_room_img
        if number[15]=='303':
            room_303=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 303',compound=TOP,command=lambda:transfer_check_in_data('303'))
            room_303.image=occ_room_img
        if number[15]=='304':
            room_304=Button(select_room_frame,image=occ_room_img,padx=10,pady=10,text='room 304',compound=TOP,command=lambda:transfer_check_in_data('304'))
            room_304.image=occ_room_img

    room_001.grid(row=1,column=0)
    room_002.grid(row=1,column=1)
    room_101.grid(row=2,column=0)
    room_102.grid(row=2,column=1)
    room_103.grid(row=2,column=2)
    room_104.grid(row=2,column=3)
    room_105.grid(row=2,column=4)
    room_106.grid(row=2,column=5)
    room_201.grid(row=3,column=0)
    room_202.grid(row=3,column=1)
    room_203.grid(row=3,column=2)
    room_204.grid(row=3,column=3)
    room_205.grid(row=3,column=4)
    room_206.grid(row=3,column=5)
    room_301.grid(row=4,column=0)
    room_302.grid(row=4,column=1)
    room_303.grid(row=4,column=2)
    room_304.grid(row=4,column=3)
...
def newcheckin():
    ...
    back_button.image=back_button_img
    back_button.grid(row=0,column=0)
    check_in_label=Label(check_in_frame,text='New Check In',padx=10,pady=10,bg=mycolor,font=('Helvetica',20),fg='white')
    check_in_label.grid(row=0,column=3)

    contact_check_label=Label(check_in_frame,bg=mycolor,text='Contact Number',padx=10,pady=20,fg='white')
    global contact_check_entry
    contact_check_entry=Entry(check_in_frame,width=30)
    contact_check_label.grid(row=1,column=0)
    contact_check_entry.grid(row=1,column=1)
    contact_check_button=Button(check_in_frame,text='check',command=check_using_contact)
    contact_check_button.grid(row=1,column=2)

    name_label=Label(check_in_frame,text='Customer Name',padx=10,pady=10,bg=mycolor,fg='white')
    global name_entry
    name_entry=Entry(check_in_frame,width=30)
    name_label.grid(row=2,column=0,sticky=W)
    name_entry.grid(row=2,column=1)

    age_label=Label(check_in_frame,text='Customer Age',padx=10,pady=10,bg=mycolor,fg='white')
    age_label.grid(row=3,column=0,sticky=W)
    global age_entry
    age_entry=Entry(check_in_frame, width=30)
    age_entry.grid(row=3,column=1)

    gender_label=Label(check_in_frame,text='Gender',padx=10,pady=10,bg=mycolor,fg='white')
    gender_label.grid(row=4,column=0,sticky=W)
    global gender_entry
    gender_entry=Entry(check_in_frame,width=30)
    gender_entry.grid(row=4,column=1)

    father_label=Label(check_in_frame,text='Father Name',padx=10,pady=10,bg=mycolor,fg='white')
    father_label.grid(row=5,column=0,sticky=W)
    global father_entry
    father_entry=Entry(check_in_frame,width=30)
    father_entry.grid(row=5,column=1)

    purpose_visit_label=Label(check_in_frame,text='Purpose of Visit',padx=10,pady=10,bg=mycolor,fg='white')
    global purpose_visit_entry
    purpose_visit_entry=Entry(check_in_frame,width=30)
    purpose_visit_label.grid(row=6,column=0,sticky=W)
    purpose_visit_entry.grid(row=6,column=1)

    #side 2
    address_label=Label(check_in_frame,text='Address',padx=10,pady=10,bg=mycolor,fg='white')
    address_label.grid(row=2,column=2,sticky=W)
    global address_entry
    address_entry=Entry(check_in_frame,width=30)
    address_entry.grid(row=2,column=3)

    city_label=Label(check_in_frame,text='City',padx=10,pady=10,bg=mycolor,fg='white')
    global city_entry
    city_entry=Entry(check_in_frame,width=30)
    city_label.grid(row=3,column=2,sticky=W)
    city_entry.grid(row=3,column=3)

    company_label=Label(check_in_frame,text='company',padx=10,pady=10,bg=mycolor,fg='white')
    company_label.grid(row=4,column=2,sticky=W)
    global company_entry
    company_entry=Entry(check_in_frame,width=30)
    company_entry.grid(row=4,column=3)

    id_type_label=Label(check_in_frame,text='ID Type',padx=10,pady=10,bg=mycolor,fg='white')
    id_type_label.grid(row=5,column=2,sticky=W)
    global id_type_entry
    id_type_entry=Entry(check_in_frame,width=30)
    id_type_entry.grid(row=5,column=3)

    room_tarrif_label=Label(check_in_frame,text='Room tarrif',padx=10,pady=10,bg=mycolor,fg='white')
    global room_tarrif_entry
    room_tarrif_entry=Entry(check_in_frame,width=30)
    room_tarrif_label.grid(row=6,column=2,sticky=W)
    room_tarrif_entry.grid(row=6,column=3)

    #side 3
    id_number_label=Label(check_in_frame,text='ID number',padx=10,pady=10,bg=mycolor,fg='white')
    id_number_label.grid(row=2,column=4,sticky=W)
    global id_number_entry
    id_number_entry=Entry(check_in_frame,width=30)
    id_number_entry.grid(row=2,column=5)

    phone_label=Label(check_in_frame,text='phone number',padx=10,pady=10,bg=mycolor,fg='white')
    global phone_entry
    phone_entry=Entry(check_in_frame,width=30)
    phone_label.grid(row=3,column=4,sticky=W)
    phone_entry.grid(row=3,column=5)

    email_label=Label(check_in_frame,text='Email',padx=10,pady=10,bg=mycolor,fg='white')
    global email_entry
    email_entry=Entry(check_in_frame,width=30)
    email_label.grid(row=4,column=4,sticky=W)
    email_entry.grid(row=4,column=5)

    arrival_from_label=Label(check_in_frame,text='Arrival From',padx=10,pady=10,bg=mycolor,fg='white')
    global arrival_from_entry
    arrival_from_entry=Entry(check_in_frame,width=30)
    arrival_from_label.grid(row=5,column=4,sticky=W)
    arrival_from_entry.grid(row=5,column=5)

    datetime_label=Label(check_in_frame,text='Date',padx=10,pady=10,bg=mycolor,fg='white')
    global datetime_entry
    datetime_entry=Entry(check_in_frame,width=30)
    ...
    no_of_person_label=Label(check_in_frame,text='Number of person',padx=10,pady=10,bg=mycolor,fg='white')
    global no_of_person_entry
    no_of_person_entry=Entry(check_in_frame,width=30)
    no_of_person_label.grid(row=7,column=2,sticky=W)
    no_of_person_entry.grid(row=7,column=3)

    submit_data_btn=Button(check_in_frame,text='Select Room',command=check_in_continue)
    submit_data_btn.grid(row=8,column=2,columnspan=2,ipadx=115,ipady=7,pady=10)
...
def search_by_day():
    ...
    table.heading('14',text='Tarrif')
    table.column("14",minwidth=0,width=50,anchor='c')
    table.heading('15',text='Check In Date')
    table.column("15",minwidth=0,width=100,anchor='c')
    table.heading('16',text='Room No.')
    table.column("16",minwidth=0,width=80,anchor='c')
    table.heading('17',text='Check Out Date')
    table.column("17",minwidth=0,width=100,anchor='c')
    table.heading('18',text='Persons')
    ...
    for record in res:
        count=1
        print_records+=str(record)+'\n'
        table.insert("", 'end', text =str(count),values =(record[0], record[1], record[2],record[3],record[4],record[5],record[6],record[7],record[8],record[9],record[10],record[11],record[12],record[13],record[14],record[15],record[16],record[17]))
        count+=1
    global query_label
...
def room_status():
    ...
    room_001=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 001',compound=TOP)
    room_001.image=vac_room_img

    room_002=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 002',compound=TOP)
    room_002.image=vac_room_img

    room_101=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 101',compound=TOP)
    room_101.image=vac_room_img

    room_102=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 102',compound=TOP)
    room_102.image=vac_room_img

    room_103=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 103',compound=TOP)
    room_103.image=vac_room_img

    room_104=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 104',compound=TOP)
    room_104.image=vac_room_img

    room_105=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 105',compound=TOP)
    room_105.image=vac_room_img

    room_106=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 106',compound=TOP)
    room_106.image=vac_room_img

    room_201=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 201',compound=TOP)
    room_201.image=vac_room_img

    room_202=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 202',compound=TOP)
    room_202.image=vac_room_img

    room_203=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 203',compound=TOP)
    room_203.image=vac_room_img

    room_204=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 204',compound=TOP)
    room_204.image=vac_room_img

    room_205=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 205',compound=TOP)
    room_205.image=vac_room_img

    room_206=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 206',compound=TOP)
    room_206.image=vac_room_img

    room_301=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 301',compound=TOP)
    room_301.image=vac_room_img

    room_302=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 302',compound=TOP)
    room_302.image=vac_room_img

    room_303=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 303',compound=TOP)
    room_303.image=vac_room_img

    room_304=Button(room_status_frame,image=vac_room_img,padx=10,pady=10,text='room 304',compound=TOP)
    room_304.image=vac_room_img

    for number in res:
        if number[15]=='1':
            room_001=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 001',compound=TOP,command=lambda:details('1'))
            room_001.image=occ_room_img
        if number[15]=='2':
            room_002=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 002',compound=TOP,command=lambda:details('2'))
            room_002.image=occ_room_img
        if number[15]=='101':
            room_101=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 101',compound=TOP,command=lambda:details('101'))
            room_101.image=occ_room_img
        if number[15]=='102':
            room_102=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 102',compound=TOP,command=lambda:details('102'))
            room_102.image=occ_room_img
        if number[15]=='103':
            room_103=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 103',compound=TOP,command=lambda:details('103'))
            room_103.image=occ_room_img
        if number[15]=='104':
            room_104=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 104',compound=TOP,command=lambda:details('104'))
            room_104.image=occ_room_img
        if number[15]=='105':
            room_105=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 105',compound=TOP,command=lambda:details('105'))
            room_105.image=occ_room_img
        if number[15]=='106':
            room_106=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 106',compound=TOP,command=lambda:details('106'))

            room_106.image=occ_room_img
        if number[15]=='201':
            room_201=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 201',compound=TOP,command=lambda:details('201'))
            room_201.image=occ_room_img
        if number[15]=='202':
            room_202=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 202',compound=TOP,command=lambda:details('202'))
            room_202.image=occ_room_img
        if number[15]=='203':
            room_203=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 203',compound=TOP,command=lambda:details('203'))
            room_104.image=occ_room_img
        if number[15]=='204':
            room_204=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 204',compound=TOP,command=lambda:details('204'))
            room_204.image=occ_room_img
        if number[15]=='205':
            room_205=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 205',compound=TOP,command=lambda:details('205'))
            room_205.image=occ_room_img
        if number[15]=='206':
            room_206=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 206',compound=TOP,command=lambda:details('206'))
            room_206.image=occ_room_img
        if number[15]=='301':
            room_301=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 301',compound=TOP,command=lambda:details('301'))
            room_301.image=occ_room_img
        if number[15]=='302':
            room_302=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 302',compound=TOP,command=lambda:details('302'))
            room_302.image=occ_room_img
        if number[15]=='303':
            room_303=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 303',compound=TOP,command=lambda:details('303'))
            room_303.image=occ_room_img
        if number[15]=='304':
            room_304=Button(room_status_frame,image=occ_room_img,padx=10,pady=10,text='room 304',compound=TOP,command=lambda:details('304'))
            room_304.image=occ_room_img
...
def current_stock():
    inventory_frame.grid_forget()
    label=Label(current_stock_frame,text='Current Stock',font=('Helvetica',16),pady=10,bg=mycolor,fg='white')
    ...
    con.commit()
    con.close()
    double_bed_sheets_label=Label(current_stock_frame,text='Double Bed Sheets',bg=mycolor,fg='white')
    double_bed_sheets_entry=Entry(current_stock_frame,width=30)
    ...
    single_bed_sheets_label=Label(current_stock_frame,text='Single Bed Sheets',bg=mycolor,fg='white')
    single_bed_sheets_entry=Entry(current_stock_frame,width=30)
    ...
    double_duet_cover_label=Label(current_stock_frame,text='Double Duet Cover',bg=mycolor,fg='white')
    double_duet_cover_entry=Entry(current_stock_frame,width=30)
    ...
    big_pillows_label=Label(current_stock_frame,text='Big Pillows',bg=mycolor,fg='white')
    big_pillows_entry=Entry(current_stock_frame,width=30)
    ...
    small_pillows_label=Label(current_stock_frame,text='Small Pillows',bg=mycolor,fg='white')
    small_pillows_entry=Entry(current_stock_frame,width=30)
    ...
    cushion_cover_label=Label(current_stock_frame,text='Cushion Covers',bg=mycolor,fg='white')
    cushion_cover_entry=Entry(current_stock_frame,width=30)
    ...
    bed_runner_label=Label(current_stock_frame,text='Bed Runners',bg=mycolor,fg='white')
    bed_runner_entry=Entry(current_stock_frame,width=30)
    ...
    towel_label=Label(current_stock_frame,text='Towels',bg=mycolor,fg='white')
    towel_entry=Entry(current_stock_frame,width=30)
    towel_entry.grid(row=2,column=5,padx=5,pady=5)
    towel_label.grid(row=2,column=4,padx=5,pady=5)
    towel_entry.insert(0,towel)

    bath_towel_label=Label(current_stock_frame,text='Bath Towel',bg=mycolor,fg='white')
    bath_towel_entry=Entry(current_stock_frame,width=30)
...
def edit_stock():
    inventory_frame.grid_forget()
    label=Label(update_stock_frame,text='Edit Stock',font=('Helvetica',16),pady=10,bg=mycolor,fg='white')
    label.grid(row=0,column=2)
    con=sqlite3.connect('Hotel_mgmt.db')
    c=con.cursor()
    c.execute('select * from stock')
    ...
    double_bed_sheets_label=Label(update_stock_frame,text='Double Bed Sheets',bg=mycolor,fg='white')
    double_bed_sheets_entry=Entry(update_stock_frame,width=30)
    double_bed_sheets_label.grid(row=1,column=0,padx=5,pady=5)
    double_bed_sheets_entry.grid(row=1,column=1,padx=5,pady=5)
    double_bed_sheets_entry.insert(0,double_bed_sheets)

    global single_bed_sheets_entry
    single_bed_sheets_label=Label(update_stock_frame,text='Single Bed Sheets',bg=mycolor,fg='white')
    single_bed_sheets_entry=Entry(update_stock_frame,width=30)
    single_bed_sheets_label.grid(row=2,column=0,padx=5,pady=5)
    single_bed_sheets_entry.grid(row=2,column=1,padx=5,pady=5)
    single_bed_sheets_entry.insert(0,single_bed_sheets)

    global double_duet_cover_entry
    double_duet_cover_label=Label(update_stock_frame,text='Double Duet Cover',bg=mycolor,fg='white')
    double_duet_cover_entry=Entry(update_stock_frame,width=30)
    double_duet_cover_label.grid(row=1,column=2,padx=5,pady=5)
    double_duet_cover_entry.grid(row=1,column=3,padx=5,pady=5)
    double_duet_cover_entry.insert(0,double_duet_cover)

    global big_pillows_entry
    big_pillows_label=Label(update_stock_frame,text='Big Pillows',bg=mycolor,fg='white')
    big_pillows_entry=Entry(update_stock_frame,width=30)
    big_pillows_label.grid(row=2,column=2,padx=5,pady=5)
    big_pillows_entry.grid(row=2,column=3,padx=5,pady=5)
    big_pillows_entry.insert(0,big_pillow)

    global small_pillows_entry
    small_pillows_label=Label(update_stock_frame,text='Small Pillows',bg=mycolor,fg='white')
    small_pillows_entry=Entry(update_stock_frame,width=30)
    small_pillows_label.grid(row=3,column=0,padx=5,pady=5)
    small_pillows_entry.grid(row=3,column=1,padx=5,pady=5)
    small_pillows_entry.insert(0,small_pillow)

    global cushion_cover_entry
    cushion_cover_label=Label(update_stock_frame,text='Cushion Covers',bg=mycolor,fg='white')
    cushion_cover_entry=Entry(update_stock_frame,width=30)
    cushion_cover_entry.grid(row=3,column=3,padx=5,pady=5)
    cushion_cover_label.grid(row=3,column=2,padx=5,pady=5)
    cushion_cover_entry.insert(0,cushion_cover)

    global bed_runner_entry
    bed_runner_label=Label(update_stock_frame,text='Bed Runners',bg=mycolor,fg='white')
    bed_runner_entry=Entry(update_stock_frame,width=30)
    bed_runner_label.grid(row=1,column=4,padx=5,pady=5)
    bed_runner_entry.grid(row=1,column=5,padx=5,pady=5)
    bed_runner_entry.insert(0,bed_runner)

    global towel_entry
    towel_label=Label(update_stock_frame,text='Towels',bg=mycolor,fg='white')
    towel_entry=Entry(update_stock_frame,width=30)
    towel_label.grid(row=2,column=4,padx=5,pady=5)
    towel_entry.grid(row=2,column=5,padx=5,pady=5)
    towel_entry.insert(0,towel)

    global bath_towel_entry
    bath_towel_label=Label(update_stock_frame,text=' Bath Towel',bg=mycolor,fg='white')
    bath_towel_entry=Entry(update_stock_frame,width=30)
    bath_towel_label.grid(row=3,column=4,padx=5,pady=5)
    bath_towel_entry.grid(row=3,column=5,padx=5,pady=5)
    bath_towel_entry.insert(0,bath_towel)

    edit_stock_btn=Button(update_stock_frame,text='Update',command=update_stock)
...
def send_laundry():
    laundry_box_frame.grid_forget()
    label=Label(send_laundry_frame,text='Send Laundry',font=('Helvetica',16),pady=10,bg=mycolor,fg='white')
    label.grid(row=0,column=2)
    ...
    global double_bed_sheets_entry
    double_bed_sheets_label=Label(send_laundry_frame,text='Double Bed Sheets',bg=mycolor,fg='white')
    double_bed_sheets_entry=Entry(send_laundry_frame,width=30)
    double_bed_sheets_label.grid(row=1,column=0,padx=5,pady=5)
    double_bed_sheets_entry.grid(row=1,column=1,padx=5,pady=5)

    global single_bed_sheets_entry
    single_bed_sheets_label=Label(send_laundry_frame,text='Single Bed Sheets',bg=mycolor,fg='white')
    single_bed_sheets_entry=Entry(send_laundry_frame,width=30)
    single_bed_sheets_label.grid(row=2,column=0,padx=5,pady=5)
    single_bed_sheets_entry.grid(row=2,column=1,padx=5,pady=5)

    global double_duet_cover_entry
    double_duet_cover_label=Label(send_laundry_frame,text='Double Duet Cover',bg=mycolor,fg='white')
    double_duet_cover_entry=Entry(send_laundry_frame,width=30)
    double_duet_cover_label.grid(row=1,column=2,padx=5,pady=5)
    double_duet_cover_entry.grid(row=1,column=3,padx=5,pady=5)

    cushion_cover_label=Label(send_laundry_frame,text='Cushion Covers',bg=mycolor,fg='white')
    global cushion_cover_entry
    cushion_cover_entry=Entry(send_laundry_frame,width=30)
    cushion_cover_label.grid(row=3,column=2,padx=5,pady=5)
    cushion_cover_entry.grid(row=3,column=3,padx=5,pady=5)

    bed_runner_label=Label(send_laundry_frame,text='Bed Runners',bg=mycolor,fg='white')
    global bed_runner_entry
    bed_runner_entry=Entry(send_laundry_frame,width=30)
    bed_runner_label.grid(row=1,column=4,padx=5,pady=5)
    bed_runner_entry.grid(row=1,column=5,padx=5,pady=5)

    global towel_entry
    towel_label=Label(send_laundry_frame,text='Towels',bg=mycolor,fg='white')
    towel_entry=Entry(send_laundry_frame,width=30)
    towel_label.grid(row=2,column=4,padx=5,pady=5)
    towel_entry.grid(row=2,column=5,padx=5,pady=5)

    global bath_towel_entry
    bath_towel_label=Label(send_laundry_frame,text='Bath Towel',bg=mycolor,fg='white')
    bath_towel_entry=Entry(send_laundry_frame,width=30)
    bath_towel_label.grid(row=2,column=2,padx=5,pady=5)
    bath_towel_entry.grid(row=2,column=3,padx=5,pady=5)

    send_laundry_btn=Button(send_laundry_frame,text='Save',command=send_complete)
...
def laundry_recieved():
    laundry_box_frame.grid_forget()
    label=Label(laundry_recieved_frame,text='Recieved Laundry',font=('Helvetica',16),pady=10,bg=mycolor,fg='white')
    label.grid(row=0,column=2)
    ...
    back_button.grid(row=0,column=0)
    global double_bed_sheets_entry
    double_bed_sheets_label=Label(laundry_recieved_frame,text='Double Bed Sheets',bg=mycolor,fg='white')
    double_bed_sheets_entry=Entry(laundry_recieved_frame,width=30)
    double_bed_sheets_label.grid(row=1,column=0,padx=5,pady=5)
    double_bed_sheets_entry.grid(row=1,column=1,padx=5,pady=5)

    global single_bed_sheets_entry
    single_bed_sheets_label=Label(laundry_recieved_frame,text='Single Bed Sheets',bg=mycolor,fg='white')
    single_bed_sheets_entry=Entry(laundry_recieved_frame,width=30)
    single_bed_sheets_label.grid(row=2,column=0,padx=5,pady=5)
    single_bed_sheets_entry.grid(row=2,column=1,padx=5,pady=5)

    global double_duet_cover_entry
    double_duet_cover_label=Label(laundry_recieved_frame,text='Double Duet Cover',bg=mycolor,fg='white')
    double_duet_cover_entry=Entry(laundry_recieved_frame,width=30)
    double_duet_cover_label.grid(row=1,column=2,padx=5,pady=5)
    double_duet_cover_entry.grid(row=1,column=3,padx=5,pady=5)

    global cushion_cover_entry
    cushion_cover_label=Label(laundry_recieved_frame,text='Cushion Covers',bg=mycolor,fg='white')
    cushion_cover_entry=Entry(laundry_recieved_frame,width=30)
    cushion_cover_label.grid(row=3,column=2,padx=5,pady=5)
    cushion_cover_entry.grid(row=3,column=3,padx=5,pady=5)

    global bed_runner_entry
    bed_runner_label=Label(laundry_recieved_frame,text='Bed Runners',bg=mycolor,fg='white')
    bed_runner_entry=Entry(laundry_recieved_frame,width=30)
    bed_runner_label.grid(row=1,column=4,padx=5,pady=5)
    bed_runner_entry.grid(row=1,column=5,padx=5,pady=5)

    global towel_entry
    towel_label=Label(laundry_recieved_frame,text='Towels',bg=mycolor,fg='white')
    towel_entry=Entry(laundry_recieved_frame,width=30)
    towel_label.grid(row=2,column=4,padx=5,pady=5)
    towel_entry.grid(row=2,column=5,padx=5,pady=5)

    global bath_towel_entry
    bath_towel_label=Label(laundry_recieved_frame,text=' Bath Towel',bg=mycolor,fg='white')
    bath_towel_entry=Entry(laundry_recieved_frame,width=30)
    bath_towel_label.grid(row=2,column=2,padx=5,pady=5)
    bath_towel_entry.grid(row=2,column=3,padx=5,pady=5)


    laundry_recieved_btn=Button(laundry_recieved_frame,text='Save',command=recieve_complete)
...
def show_sent_laundry():
    laundry_box_frame.grid_forget()
    show_send_laundry_frame.grid_forget()
    label=Label(show_send_laundry_frame,text='Send Laundry',font=('Helvetica',16),pady=10,bg=mycolor,fg='white')
    label.grid(row=0,column=7)
    back_button=Button(show_send_laundry_frame,image=back_button_img,command=lambda:back_home('show_send_laundry_frame'),bg=mycolor)
    back_button.image=back_button_img
    back_button.grid(row=0,column=0)
    global day_between_1
...
def show_rec_laundry():
    laundry_box_frame.grid_forget()
    label=Label(show_rec_laundry_frame,text='Recieved Laundry',font=('Helvetica',18),pady=10,bg=mycolor,fg='white')
    label.grid(row=0,column=3)
    back_button=Button(show_rec_laundry_frame,image=back_button_img,command=lambda:back_home('show_rec_laundry_frame'),bg=mycolor)
    back_button.image=back_button_img
    back_button.grid(row=0,column=0)
    global day_between_1
...
def check_out_complete(room_no):
    ...
    con=sqlite3.connect('hotel_mgmt.db')
    c=con.cursor()
    c.execute('select * from check_in_data where room_no='+room_no)
    res=c.fetchall()
    result=[]
    for record in res:
...
def check_out():
    ...
    back_button.image=back_button_img
    select_room_label=Label(check_out_frame,text='Click on the room to check out',font=('Helvetica',15),height=2)
    ...
    room_001=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 001',compound=TOP)
    room_001.image=vac_room_img

    room_002=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 002',compound=TOP)
    room_002.image=vac_room_img

    room_101=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 101',compound=TOP)
    room_101.image=vac_room_img

    room_102=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 102',compound=TOP)
    room_102.image=vac_room_img

    room_103=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 103',compound=TOP)
    room_103.image=vac_room_img

    room_104=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 104',compound=TOP)
    room_104.image=vac_room_img

    room_105=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 105',compound=TOP)
    room_105.image=vac_room_img

    room_106=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 106',compound=TOP)
    room_106.image=vac_room_img

    room_201=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 201',compound=TOP)
    room_201.image=vac_room_img

    room_202=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 202',compound=TOP)
    room_202.image=vac_room_img

    room_203=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 203',compound=TOP)
    room_203.image=vac_room_img

    room_204=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 204',compound=TOP)
    room_204.image=vac_room_img

    room_205=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 205',compound=TOP)
    room_205.image=vac_room_img

    room_206=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 206',compound=TOP)
    room_206.image=vac_room_img

    room_301=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 301',compound=TOP)
    room_301.image=vac_room_img

    room_302=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 302',compound=TOP)
    room_302.image=vac_room_img

    room_303=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 303',compound=TOP)
    room_303.image=vac_room_img

    room_304=Button(check_out_frame,image=vac_room_img,padx=10,pady=10,text='room 304',compound=TOP)
    room_304.image=vac_room_img

    for number in res:
        if number[15]=='1':
            room_001=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 001',compound=TOP,command=lambda:check_out_complete('1'))
            room_001.image=occ_room_img
        if number[15]=='2':
            room_002=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 002',compound=TOP,command=lambda:check_out_complete('2'))
            room_002.image=occ_room_img
        if number[15]=='101':
            room_101=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 101',compound=TOP,command=lambda:check_out_complete('101'))
            room_101.image=occ_room_img
        if number[15]=='102':
            room_102=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 102',compound=TOP,command=lambda:check_out_complete('102'))
            room_102.image=occ_room_img
        if number[15]=='103':
            room_103=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 103',compound=TOP,command=lambda:check_out_complete('103'))
            room_103.image=occ_room_img
        if number[15]=='104':
            room_104=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 104',compound=TOP,command=lambda:check_out_complete('104'))
            room_104.image=occ_room_img
        if number[15]=='105':
            room_105=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 105',compound=TOP,command=lambda:check_out_complete('105'))
            room_105.image=occ_room_img
        if number[15]=='106':
            room_106=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 106',compound=TOP,command=lambda:check_out_complete('106'))
            room_106.image=occ_room_img
        if number[15]=='201':
            room_201=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 201',compound=TOP,command=lambda:check_out_complete('201'))
            room_201.image=occ_room_img
        if number[15]=='202':
            room_202=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 202',compound=TOP,command=lambda:check_out_complete('202'))
            room_202.image=occ_room_img
        if number[15]=='203':
            room_203=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 203',compound=TOP,command=lambda:check_out_complete('203'))
            room_104.image=occ_room_img
        if number[15]=='204':
            room_204=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 204',compound=TOP,command=lambda:check_out_complete('204'))
            room_204.image=occ_room_img
        if number[15]=='205':
            room_205=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 205',compound=TOP,command=lambda:check_out_complete('205'))
            room_205.image=occ_room_img
        if number[15]=='206':
            room_206=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 206',compound=TOP,command=lambda:check_out_complete('206'))
            room_206.image=occ_room_img
        if number[15]=='301':
            room_301=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 301',compound=TOP,command=lambda:check_out_complete('301'))
            room_301.image=occ_room_img
        if number[15]=='302':
            room_302=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 302',compound=TOP,command=lambda:check_out_complete('302'))
            room_302.image=occ_room_img
        if number[15]=='303':
            room_303=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 303',compound=TOP,command=lambda:check_out_complete('303'))
            room_303.image=occ_room_img
        if number[15]=='304':
            room_304=Button(check_out_frame,image=occ_room_img,padx=10,pady=10,text='room 304',compound=TOP,command=lambda:check_out_complete('304'))
            room_304.image=occ_room_img
